---
layout: post
title: ThinkPHP 5.1 configuration tips
date: 2018-01-17 19:00:00
tag: ThinkPHP5.1
--- 
```
www  WEB部署目录（或者子目录）  5.1
├─application           应用目录
│  ├─common             公共模块目录（可以更改）
│  ├─module_name        模块目录
│  │  ├─common.php      模块函数文件
...
# 一、 ThinkPHP5.1 配置
1. 用`config`目录取代 `config.php` 应用（公共）配置文件
2. 一级配置名称就是配置文件的名称
3. 用`route`目录取代`route.php`路由配置文件
